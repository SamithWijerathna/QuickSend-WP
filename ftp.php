...
class FTP_SFTP_File_Transfer_Plugin {
    ...
    private function validateResumePosition($sftp, $remotePath, $offset) {
     ...
     public function add_admin_menu()
        {
            add_menu_page('Quick Send', 'Quick Send', 'manage_options', 'quick-send', [$this, 'admin_page'], 'dashicons-superhero', 60);
        }

    public function enqueue_scripts($hook) {
        if ('toplevel_page_quick-send' != $hook) {
            return;
        }
        
        wp_enqueue_style('quicksend-css', plugins_url('assets/css/quicksend.css', __FILE__));
        ...
        ";
        wp_add_inline_style('quicksend-css', $custom_css);
    }
            ...
            <div class="connection-form">
                ...
                <table class="form-table">
                   ...
                   <tr>
                        <th>Password/Key</th>
                        <td>
                            <input type="password" id="pass" placeholder="password or private key path" class="regular-text">
